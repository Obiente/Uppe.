...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/Obiente/Uppe/apps/server/gen/settings/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	// SettingsServiceGetNodeIdentityProcedure is the fully-qualified name of the SettingsService's
	// GetNodeIdentity RPC.
	SettingsServiceGetNodeIdentityProcedure = "/settings.v1.SettingsService/GetNodeIdentity"
)
...
type SettingsServiceClient interface {
	...
	GetNodeIdentity(context.Context, *connect.Request[v1.GetNodeIdentityRequest]) (*connect.Response[v1.NodeIdentity], error)
}
...
func NewSettingsServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) SettingsServiceClient {
	...
	return &settingsServiceClient{
		...
		getNodeIdentity: connect.NewClient[v1.GetNodeIdentityRequest, v1.NodeIdentity](
			httpClient,
			baseURL+SettingsServiceGetNodeIdentityProcedure,
			connect.WithSchema(settingsServiceMethods.ByName("GetNodeIdentity")),
			connect.WithClientOptions(opts...),
		),
	}
}
...
type settingsServiceClient struct {
	...
	getNodeIdentity *connect.Client[v1.GetNodeIdentityRequest, v1.NodeIdentity]
}

// GetSettings calls settings.v1.SettingsService.GetSettings.
func (c *settingsServiceClient) GetSettings(ctx context.Context, req *connect.Request[v1.GetSettingsRequest]) (*connect.Response[v1.Settings], error) {
	return c.getSettings.CallUnary(ctx, req)
}

// UpdateSettings calls settings.v1.SettingsService.UpdateSettings.
func (c *settingsServiceClient) UpdateSettings(ctx context.Context, req *connect.Request[v1.UpdateSettingsRequest]) (*connect.Response[v1.Settings], error) {
	return c.updateSettings.CallUnary(ctx, req)
}

// GetNodeIdentity calls settings.v1.SettingsService.GetNodeIdentity.
func (c *settingsServiceClient) GetNodeIdentity(ctx context.Context, req *connect.Request[v1.GetNodeIdentityRequest]) (*connect.Response[v1.NodeIdentity], error) {
	return c.getNodeIdentity.CallUnary(ctx, req)
}
...
func NewSettingsServiceHandler(svc SettingsServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	settingsServiceGetNodeIdentityHandler := connect.NewUnaryHandler(
		SettingsServiceGetNodeIdentityProcedure,
		svc.GetNodeIdentity,
		connect.WithSchema(settingsServiceMethods.ByName("GetNodeIdentity")),
		connect.WithHandlerOptions(opts...),
	)
	return "/settings.v1.SettingsService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		case SettingsServiceGetNodeIdentityProcedure:
			settingsServiceGetNodeIdentityHandler.ServeHTTP(w, r)
		default:
			http.NotFound(w, r)
		}
	})
...
func (UnimplementedSettingsServiceHandler) GetSettings(context.Context, *connect.Request[v1.GetSettingsRequest]) (*connect.Response[v1.Settings], error) {
...
func (UnimplementedSettingsServiceHandler) UpdateSettings(context.Context, *connect.Request[v1.UpdateSettingsRequest]) (*connect.Response[v1.Settings], error) {
...
func (UnimplementedSettingsServiceHandler) GetNodeIdentity(context.Context, *connect.Request[v1.GetNodeIdentityRequest]) (*connect.Response[v1.NodeIdentity], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("settings.v1.SettingsService.GetNodeIdentity is not implemented"))
}
