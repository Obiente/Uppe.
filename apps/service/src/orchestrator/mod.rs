...
use crate::monitoring::{MonitoringExecutor, MonitoringScheduler, CheckResult};
...
impl Orchestrator {
    ...
    pub async fn new(config: Config, pool: LibsqlPool) -> Result<()> {
    ...
    async fn run(&self) -> Result<()> {
        ...
        let _handles = scheduler.schedule_monitors(monitor_configs);
