#![allow(dead_code, reason = "Protocol topic catalog, including reserved peer recovery topics")]
...
impl TopicManager {
    pub fn new() -> Self {
        Self { subscribed: std::sync::Arc::new(tokio::sync::RwLock::new(Vec::new())) }
    }
...
mod tests {
    ...
    async fn test_private_result_topics() {
        ...
        assert_eq!(topic, format!("/uppe/private-results/{}/v1", owner_id));
