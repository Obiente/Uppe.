...
pub fn render(f: &mut Frame, size: Rect) {
    ...
    let help_lines = vec![
        ...
        Line::from(vec![
            Span::raw("  "),
            Span::styled("a", key),
            Span::raw(" add private monitor   "),
            Span::styled("A", key),
            Span::raw(" add public monitor"),
        ]),
        Line::from(vec![
            Span::raw("  "),
            Span::styled("e", key),
        ...
        Line::from(vec![
            Span::raw("  "),
            Span::styled("x", key),
            Span::raw(" quick DHT query   "),
            Span::styled("g", key),
            Span::raw(" custom key query"),
        ]),
        Line::from(vec![
            Span::raw("  "),
            Span::styled("Up/Down", key),
            Span::raw(" select bucket   "),
            Span::styled("Left/Right", key),
            Span::raw(" select peer"),
        ]),
        Line::from(""),
        Line::from(Span::styled("Edit Form:", section)),
        Line::from(vec![
            Span::raw("  "),
            Span::styled("Tab/Up/Down", key),
